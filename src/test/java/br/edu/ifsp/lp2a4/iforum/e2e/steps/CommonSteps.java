...
public class CommonSteps extends BaseE2E {
	...
	public void devo_ser_redirecionado_para_a_pagina(String nomePagina) {
		...
		assertThat(title).contains(pageAndTitle.get(nomePagina));
...
//	}
	...
	public void eu_devo_ver_a_mensagem(String expectedMessage) {
		...
		String result = new WebDriverWait(driver, DefaultWaitTime).until(new ExpectedCondition<String>() {
			public String apply(WebDriver d) {
